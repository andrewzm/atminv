...
load("~/Desktop/Chemometrics_results/train_idx.rda")
...
if(!load_results) {
    ...
    load(file="~/Desktop/Chemometrics_results/UK_results_q.dat")
}

if(cache_results) {
    save(q,i,file="~/Desktop/Chemometrics_results/UK_results_q.dat")
}
