...
\hlstd{model} \hlkwb{=} \hlstr{"full_big"}  \hlcom{## Either sparse or full or full_big or diag}
\hlstd{misspecification} \hlkwb{=} \hlnum{0}
\hlcom{#set.seed(25)        # deprecated, ignore}
...
\hlstd{\}} \hlkwa{else if}\hlstd{(model} \hlopt{==} \hlstr{"full_big"}\hlstd{) \{}
    ...
    \hlstd{corr_s_mat} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{theta_s}\hlstd{) atminv}\hlopt{:::}\hlkwd{corr_s}\hlstd{(}\hlkwc{s} \hlstd{= s_axis,}\hlkwc{theta_s} \hlstd{= theta_s)}
    \hlstd{corr_t_mat} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{theta_t}\hlstd{) atminv}\hlopt{:::}\hlkwd{corr_t}\hlstd{(}\hlkwc{t} \hlstd{= t_axis,}\hlkwc{theta_t} \hlstd{= theta_t)}
    \hlstd{d_corr_s_mat} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{theta_s}\hlstd{) atminv}\hlopt{:::}\hlkwd{d_corr_s}\hlstd{(}\hlkwc{s} \hlstd{= s_axis,}\hlkwc{theta_s} \hlstd{= theta_s)}
    \hlstd{d_corr_t_mat} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{theta_t}\hlstd{) atminv}\hlopt{:::}\hlkwd{d_corr_t}\hlstd{(}\hlkwc{t} \hlstd{= t_axis,}\hlkwc{theta_t} \hlstd{= theta_t)}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Joining by: c("{}s"{}, "{}t"{})}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in readChar(con, 5L, useBytes = TRUE): cannot open compressed file '', probable reason 'No such file or directory'}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in readChar(con, 5L, useBytes = TRUE): cannot open the connection}}\begin{alltt}
\hlkwa{if}\hlstd{(cache_results} \hlopt{&} \hlstd{model} \hlopt{==} \hlstr{"full_big"}\hlstd{)}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plot}\hlstd{(X}\hlopt{$}\hlstd{theta[}\hlnum{1}\hlstd{,])}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(X\$theta[1, ]): object 'X' not found}}\begin{alltt}
\hlkwd{plot}\hlstd{(X}\hlopt{$}\hlstd{theta[}\hlnum{2}\hlstd{,])}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(X\$theta[2, ]): object 'X' not found}}\begin{alltt}
\hlkwd{plot}\hlstd{(X}\hlopt{$}\hlstd{theta[}\hlnum{3}\hlstd{,])}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(X\$theta[3, ]): object 'X' not found}}\end{kframe}
\end{knitrout}
\end{center}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in Yf\_marg\_approx\_fns(s = s\_obs, C\_m = C\_m, Qobs = Qobs, B = B, : object 'X' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in diag(1/(X\$lap\_approx\$Yf\textasciicircum{}2)): error in evaluating the argument 'x' in selecting a method for function 'diag': Error: object 'X' not found}}\begin{alltt}
...
\hlstd{N} \hlkwb{<-} \hlnum{10000}                 \hlcom{# number of samples}
\hlstd{q} \hlkwb{<-} \hlkwd{matrix}\hlstd{(}\hlnum{0}\hlstd{,}\hlkwd{nrow}\hlstd{(M),N)}   \hlcom{# matrix for storing samples}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in nrow(M): object 'M' not found}}\begin{alltt}
...
\hlstd{dither} \hlkwb{<-} \hlstd{i} \hlkwb{<-} \hlstd{count} \hlkwb{<-} \hlnum{1}  \hlcom{# no dithering, initialise counts}
 ...
 \hlkwa{if}\hlstd{(}\hlopt{!}\hlstd{(N}\hlopt{==}\hlnum{10000}\hlstd{)} \hlopt{&} \hlstd{cache_results)}
   \hlkwd{stop}\hlstd{(}\hlstr{"Cannot cache unless N =10000"}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in stopifnot(is.function(U)): object 'lap2' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in print(paste0("{}Sample: "{}, i, "{} Acceptance rate: "{}, (nrow(unique(t(q))) - : error in evaluating the argument 'x' in selecting a method for function 'print': Error in t.default(q) : argument is not a matrix\\\#\# Calls: paste0 -> nrow -> unique -> t -> t -> t.default}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in t(q[1:length(X\$ind), -c(1:1000, i)]): error in evaluating the argument 'x' in selecting a method for function 't': Error: object 'X' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in inherits(plot, "{}ggplot"{}): object 'g' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in print(g): error in evaluating the argument 'x' in selecting a method for function 'print': Error: object 'g' not found}}\end{kframe}
\end{knitrout}
\end{center}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in q[j, 1:(N - 1)]: object of type 'closure' is not subsettable}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in q[j, 1:(N - 1)]: object of type 'closure' is not subsettable}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'Q\_zeta' not found}}\begin{alltt}
\hlstd{S_post} \hlkwb{<-} \hlkwd{chol2inv}\hlstd{(}\hlkwd{chol}\hlstd{(Q_post))}              \hlcom{# conditional covariance of Ym}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in chol2inv(chol(Q\_post)): error in evaluating the argument 'x' in selecting a method for function 'chol2inv': Error in chol(Q\_post) : \\\#\#\ \  error in evaluating the argument 'x' in selecting a method for function 'chol': Error: object 'Q\_post' not found}}\begin{alltt}
\hlstd{L_S_post} \hlkwb{<-} \hlkwd{t}\hlstd{(}\hlkwd{chol}\hlstd{(S_post))}                   \hlcom{# Cholesky decomposition of above}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in t(chol(S\_post)): error in evaluating the argument 'x' in selecting a method for function 't': Error in chol(S\_post) : \\\#\#\ \  error in evaluating the argument 'x' in selecting a method for function 'chol': Error: object 'S\_post' not found}}\begin{alltt}
\hlstd{SQB} \hlkwb{<-} \hlstd{S_post} \hlopt{%*%} \hlstd{Q_zeta} \hlopt{%*%} \hlstd{B[,X}\hlopt{$}\hlstd{ind]}        \hlcom{# weight given to flux sample}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'S\_post' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in as.vector(SQB \%*\% q[, i] + StCQoz): error in evaluating the argument 'x' in selecting a method for function 'as.vector': Error: object 'SQB' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in subset(s\_obs\_old, s == new\_obs): object 's\_obs\_old' not found}}\begin{alltt}
\hlkwa{if}\hlstd{(}\hlopt{!}\hlstd{misspecification)}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in apply(q, 1, mean): dim(X) must have a positive length}}\begin{alltt}
\hlstd{post_unc} \hlkwb{<-} \hlkwd{apply}\hlstd{(q,}\hlnum{1}\hlstd{,var)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in apply(q, 1, var): dim(X) must have a positive length}}\begin{alltt}
\hlkwd{print}\hlstd{(}\hlkwd{paste0}\hlstd{(}\hlstr{"S1f = "}\hlstd{,} \hlkwd{sqrt}\hlstd{(}\hlkwd{mean}\hlstd{(residual}\hlopt{^}\hlnum{2}\hlstd{))))}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in print(paste0("{}S1f = "{}, sqrt(mean(residual\textasciicircum{}2)))): error in evaluating the argument 'x' in selecting a method for function 'print': Error in mean(residual\textasciicircum{}2) : \\\#\#\ \  error in evaluating the argument 'x' in selecting a method for function 'mean': Error: object 'residual' not found\\\#\# Calls: paste0 -> mean}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in print(paste0("{}S2f = "{}, sqrt(mean(residual\textasciicircum{}2)/mean(post\_unc)))): error in evaluating the argument 'x' in selecting a method for function 'print': Error in mean(residual\textasciicircum{}2) : \\\#\#\ \  error in evaluating the argument 'x' in selecting a method for function 'mean': Error: object 'residual' not found\\\#\# Calls: paste0 -> mean}}\begin{alltt}
\hlcom{# MF errors}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in apply(mf\_samp[rm\_idx, ], 1, mean): object 'rm\_idx' not found}}\begin{alltt}
\hlstd{post_unc} \hlkwb{<-} \hlkwd{apply}\hlstd{(mf_samp[rm_idx,],}\hlnum{1}\hlstd{,var)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in apply(mf\_samp[rm\_idx, ], 1, var): object 'rm\_idx' not found}}\begin{alltt}
\hlkwd{print}\hlstd{(}\hlkwd{paste0}\hlstd{(}\hlstr{"S1m = "}\hlstd{,} \hlkwd{sqrt}\hlstd{(}\hlkwd{mean}\hlstd{(residual}\hlopt{^}\hlnum{2}\hlstd{))))}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in print(paste0("{}S1m = "{}, sqrt(mean(residual\textasciicircum{}2)))): error in evaluating the argument 'x' in selecting a method for function 'print': Error in mean(residual\textasciicircum{}2) : \\\#\#\ \  error in evaluating the argument 'x' in selecting a method for function 'mean': Error: object 'residual' not found\\\#\# Calls: paste0 -> mean}}\end{kframe}
\end{knitrout}
